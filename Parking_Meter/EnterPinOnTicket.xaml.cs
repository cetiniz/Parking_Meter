...
namespace Parking_Meter
{
    ...
    /// </summary>
    public sealed partial class EnterPinOnTicket : Page
    {
        String PIN;

        public EnterPinOnTicket()
        {
        ...
        private async void goFinal(object sender, RoutedEventArgs e)
        {
            ...
            { 
                int[] passArgs = { 30, 0, Convert.ToInt32(this.PIN) };
                this.Frame.Navigate(typeof(AddTimetoTicket), passArgs);
            }
            else
            {
